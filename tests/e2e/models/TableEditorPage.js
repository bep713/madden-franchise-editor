...
class TableEditorPage {
  constructor(window) {
    ...
    this.locators = {
      ...
      jumpToColumnModalSelector: this.window.locator(
        ".jump-to-column-modal .selectr-container",
      ),
      selectedCellEditReference: this.window.locator(
        ".table-content-wrapper td.current .edit-button",
      ),
    };
  }

...
class BinaryBlobRenderer {
  ...
  _blobEditorOnClick(td, row, col, value) {
    this.tableEditorWrapper.blobEditor.blobEditorWrapper.classList.remove(
      "hidden",
    );
    this.tableEditorWrapper.blobEditor.blobEditorUnderlay.classList.remove(
      "hidden",
    );

    this.tableEditorWrapper.blobEditor.blobEditorWrapper.dataset.selectedRow =
      row;
    this.tableEditorWrapper.blobEditor.blobEditorWrapper.dataset.selectedCol =
      col;

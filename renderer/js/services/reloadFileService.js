...
function addEventListeners() {
  ...
  const saveNewAction =
    reloadFileService.reloadWrapper.querySelector(".save-new-action");
  saveNewAction.addEventListener("click", function () {
    window.electronAPI.send("save-new-file");
    hideReloadWrapper();
  });

  const dismissAction =
    reloadFileService.reloadWrapper.querySelector(".dismiss-action");

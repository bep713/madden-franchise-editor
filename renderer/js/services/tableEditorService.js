...
tableEditorService.wrapper = null;
...
tableEditorService.start = (file) => {
    tableEditorService.wrapper = new TableEditorWrapper(file);
};

tableEditorService.onClose = () => {
    tableEditorService.wrapper.close();
};
